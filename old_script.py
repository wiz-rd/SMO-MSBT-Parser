#!/usr/bin/python3
"""
Saving this for archival purposes, and if I ever plan to try and reconstruct the input.
"""
...
# decoding from Kuriimu output ONLY
# this cannot decode from MSBT files directly.
# MSBT files have a weird 2d kind of layout
# that I can't wrap my head around,
# so this is more of a jerry-rig to correct
# Kuriimu output more than anythin
DECODING_DICTIONARY = {
    "<null>L<null>": "Mario",
    "<null>N<null>": "Mario_Icon_Capnon",
    "<null>D<null>": "Peach_Icon",
    "<null>O<null>": "Mayor_Icon",  # Pauline
    "<null>O<null>": "Mayor_Icon_2",
    # why did they break the naming standard??
    "<null>O<null>": "PaulineAtCeremony_Icon",
    "<null>C<null>": "Koopa_Icon",  # Bowser
    "<null>C<null>": "Boss_Koopa_Icon",  # Also bowser? Maybe while in a suit
    "<null>H<null>": "Stacker",  # Topper
    "<null>F<null>": "CapThrower",  # Rango
    "	<null>I<null>": "BombThrower",  # Harriet
    "<null>G<null>": "FireBlower",  # Spewert..?
    # I'm assuming all the broodals. It looks like it, at least
    "<null>G<null> <null>H<null> <null>F<null> 	<null>I<null>": "GateKeepers_Icon",
    "3<null>9<null>": "TimeBalloonNpc_Icon",  # Ballon World Luigi
    "<null>E<null>": "Tiara_Icon",  # Tiara
